...
pip install -U pyats[full] genie pyopenssl==21.0.0 markupsafe==2.0.1 cryptography requests cmlutils Jinja2==2.11.3 ansible==2.9.27 paramiko==2.12.0 chardet==3.0.4
